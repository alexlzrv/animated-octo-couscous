...
// - unmarshal - проверяет передачу типов, не являющихся указателями или неинтерфейсами, для функций демаршалинга и декодирования.
...
func GetAnalysis() []*analysis.Analyzer {
